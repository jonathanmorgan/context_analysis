...
class Reliability_Names( models.Model ):
    ...
    coder1 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder1_set" )
    ...
    coder2 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder2_set" )
    ...
    coder3 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder3_set" )
    ...
    coder4 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder4_set" )
    ...
    coder5 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder5_set" )
    ...
    coder6 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder6_set" )
    ...
    coder7 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder7_set" )
    ...
    coder8 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder8_set" )
    ...
    coder9 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder9_set" )
    ...
    coder10 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_coder10_set" )
...
class Reliability_Names_Evaluation( models.Model ):
    ...
    is_human_error = models.BooleanField( default = False )
    ...
    is_missed_subject = models.BooleanField( default = False )
    is_missed_author = models.BooleanField( default = False )
    is_skipped = models.BooleanField( default = False )
    is_author_shb_subject = models.BooleanField( default = False )
    is_subject_shb_author = models.BooleanField( default = False )
    ...
    # error and analysis tag booleans.
    is_attribution_compound = models.BooleanField( default = False )
    is_attribution_follow_on = models.BooleanField( default = False )
    is_attribution_pronoun = models.BooleanField( default = False )
    is_attribution_second_hand = models.BooleanField( default = False )
    is_complex = models.BooleanField( default = False )
    is_compound_names = models.BooleanField( default = False )
    is_contributed_to = models.BooleanField( default = False )
    is_dictionary_error = models.BooleanField( default = False )
    is_disambiguation = models.BooleanField( default = False )
    is_editing_error = models.BooleanField( default = False )
    is_error = models.BooleanField( default = False )
    is_foreign_names = models.BooleanField( default = False )
    is_gender_confusion = models.BooleanField( default = False )
    is_initials_error = models.BooleanField( default = False )
    is_interesting = models.BooleanField( default = False )
    is_layout_or_design = models.BooleanField( default = False )
    ...
    is_quote_distance = models.BooleanField( default = False )
    is_said_verb = models.BooleanField( default = False )
    is_short_n_gram = models.BooleanField( default = False )
    is_software_error = models.BooleanField( default = False )
    is_spanish = models.BooleanField( default = False )
    is_sports = models.BooleanField( default = False )
    is_straightforward = models.BooleanField( default = False )
    is_title = models.BooleanField( default = False )
    is_title_complex = models.BooleanField( default = False )
    is_title_prefix = models.BooleanField( default = False )
...
class Reliability_Ties( models.Model ):
    ...
    person = models.ForeignKey( Person, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_from_set" )
    person_name = models.CharField( max_length = 255, blank = True, null = True )
    person_type = models.CharField( max_length = 255, blank = True, null = True )
    relation_type = models.CharField( max_length = 255, blank = True, null = True )
    relation_person = models.ForeignKey( Person, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_to_set" )
    ...
    coder1 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder1_set" )
    ...
    coder2 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder2_set" )
    ...
    coder3 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder3_set" )
    ...
    coder4 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder4_set" )
    ...
    coder5 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder5_set" )
    ...
    coder6 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder6_set" )
    ...
    coder7 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder7_set" )
    ...
    coder8 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder8_set" )
    ...
    coder9 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder9_set" )
    ...
    coder10 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_ties_coder10_set" )
...
class Field_Spec_Value( models.Model ):
    ...
    field_spec = models.ForeignKey( Field_Spec, on_delete = models.CASCADE )
...
class Reliability_Names_Coder_Data( models.Model ):
    ...
    reliability_names = models.ForeignKey( Reliability_Names, on_delete = models.CASCADE, blank = True, null = True )
    coder = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True )
...
class Reliability_Names_Results( models.Model ):
    ...
    label = models.CharField( max_length = 255, blank = True, null = True )
    coder1 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_results_coder1_set" )
    coder1_coder_index = models.IntegerField( blank = True, null = True )
    coder2 = models.ForeignKey( User, on_delete = models.DO_NOTHING, blank = True, null = True, related_name = "reliability_names_results_coder2_set" )
...
class Reliability_Result_Details( models.Model ):
    ...
    reliability_names_results = models.ForeignKey( Reliability_Names_Results, on_delete = models.CASCADE )
    field_spec = models.ForeignKey( Field_Spec, on_delete = models.CASCADE )
